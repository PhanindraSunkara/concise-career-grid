      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="animate-fade-up">
          ...
          <div className="w-32 h-32 mx-auto mb-8 rounded-full bg-white/20 backdrop-blur-sm border-4 border-white/30 shadow-hero flex items-center justify-center">
            <div className="w-24 h-24 rounded-full bg-white/30 flex items-center justify-center text-4xl font-bold text-white">
              JP
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="bg-white/10 border-white/30 text-white hover:bg-white hover:text-primary backdrop-blur-sm text-lg px-8"
              onClick={() => {
